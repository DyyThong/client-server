...
def client_send():
    ...
    while True:
        data_1,data_2,data_3,data_4,data_5,data_6,data_7,data_8,data_9,data_10,data_11,data_12 = data_computer()
        data_list_2 = [str(data_[0]),str(data_1),str(data_2),str(data_3),str(data_4),str(data_5),str(data_6),str(data_7),str(data_8),str(data_9),str(data_10),str(data_11),str(data_12)]
